...
let auth: CodexAuth = { mode: "codex", hasApiKey: false, hasEnvironmentKey: false, keySource: "" };
...
export function notifyCodexAuth(value: unknown) {
  ...
  auth = { mode: next.mode, hasApiKey: next.hasApiKey, hasEnvironmentKey: next.hasEnvironmentKey === true, keySource: next.keySource === "session" || next.keySource === "environment" ? next.keySource : "" };
